...
// 0176-7900-6066-03
// Excersice Object Array


// wrte a program that print all the car company and year number from the list make 

type cartype = { company: string, color: string, year: number, carface?: string }
var car: cartype[] = [{
    company: "Honda",
    color: "Black",
    carface: "reglar",
